...
TEST_FUNCTION(uws_client_sends_an_RFC_6874_encoded_zone_in_the_Host_authority)
{
    const char expected_upgrade_request[] = "GET /aaa HTTP/1.1\r\n"
        "Host: [fe80::1%25eth0]:444\r\n"
        "Upgrade: websocket\r\n"
        "Connection: Upgrade\r\n"
        "Sec-WebSocket-Key: test_str\r\n"
        "Sec-WebSocket-Version: 13\r\n"
...
TEST_FUNCTION(uws_client_percent_encodes_reserved_bytes_in_an_IPv6_zone_Host_authority)
{
    const char expected_upgrade_request[] = "GET /aaa HTTP/1.1\r\n"
        "Host: [fe80::1%25Ethernet%202]:444\r\n"
        "Upgrade: websocket\r\n"
        "Connection: Upgrade\r\n"
        "Sec-WebSocket-Key: test_str\r\n"
        "Sec-WebSocket-Version: 13\r\n"
